...
//                    "Pretty good! Or, so I hope " +  Emotes.OriHeart.ToString()!,
//                    "You could just ask him, I guess. Oh! - But make sure no one else has pinged him about it in the past couple hours, or you might bother him " +  Emotes.OriCry.ToString()!,
//                }
//        },
//        [new OptionSet()
//        {
...
//        {
//            Options = new string[] {
//                    $"Knowing him? Probably making something! { Emotes.OriHype.ToString()!} ...Or breaking something. Or sleeping!",
//                    "You could just ask him, I guess. Oh! - But make sure no one else has pinged him about it in the past couple hours, or you might bother him " +  Emotes.OriCry.ToString()!,
//                    "Does his status say anything? I'd look there, he sets that a lot " +  Emotes.OriHeart.ToString()!,
...
//    public async Task ExecuteHandlerAsync(SocketCommandContext context)
//    {
...
//            {
//                // TODO: What is Ori's Gender? response
//                await context.Message.ReplyAsync("You can refer to me by anything, really! Choose whatever term you think fits me best.");
//                return;
//            }
//        }
...
//        if (MemberLastUsedEpoch.ContainsKey(context.User.Id))
//        {
//            DateTime lastUsed = DateTime.FromBinary(MemberLastUsedEpoch[context.User.Id]);
...
//                    {
//                        _logger.LogInformation("Today is not Ori's birthday.");
//                        // "Today's not my birthday! It's on the 11th of March."
...
//                        {
//                            // TODO: Random Ku Response
//                            await context.Message.ReplyAsync(Emotes.OriKu + ": " + RandomKuResponse + $"\n\n{Emotes.OriFace}: " + resp);
//                            return; // Exit here.
//                        }
//                        else
//                        {
...
//                {
//                    await context.Message.ReplyAsync("I mean, yeah, you *can* technically query the system with that, ... https://tenor.com/view/why-huh-but-why-gif-13199396");
//                    return;
//                }

//                string response = ResponseOptions[options].RandomEntry.Replace("{USERPING}", $"{context.User.Mention}");
//                if (RandomlyUseKuResponse)
//                {
//                    // TODO: Random Ku Response
//                    response = Emotes.OriKu + ": " + RandomKuResponse + $"\n\n{Emotes.OriFace}: " + response;
//                }
